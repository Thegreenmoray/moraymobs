...
public class EntityTagGenerator extends EntityTypeTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(EntityTypeTags.ARTHROPOD).add(Mobregistries.ROCKPUP.get(),
                        Mobregistries.VOLCANOBACK.get(),
                        Mobregistries.OMNIDENS.get(),
                        Mobregistries.MICRODICTYON.get(),
                        Mobregistries.WALLISEROPS.get(),
                        Mobregistries.SCHINDERHANNES.get());
    this.tag(EntityTypeTags.UNDEAD).add(Mobregistries.MORAY.get(),Mobregistries.DULLAHAN.get());
