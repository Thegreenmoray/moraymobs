...
if (living!=null){
    ...
    if(count==20){
       Microprojectile microprojectile = new Microprojectile(this.microdictyon.level());
        ...
        microprojectile.setPos(this.microdictyon.getX() + vec3.x * 4.0, this.microdictyon.getY(0.33333)+0.5, this.microdictyon.getZ() + vec3.z * 4.0);
        ...
        microprojectile.setDeltaMovement(vec31.normalize().scale(0.0009));
