package com.moray.moraymobs.worldgen.structures;
//Thanks Telepathic Grunt.
/*
public class OmnidensDungeon extends Structure {
    ...
    public static final MapCodec<OmnidensDungeon> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(CUSTOM_STRUCTURE_SETTINGS_CODEC.forGetter(structureInfo -> structureInfo.modifiableStructureInfo().getOriginalStructureInfo().structureSettings()),
                    StructureTemplatePool.CODEC.fieldOf("start_pool.json").forGetter(structure -> structure.startPool),
            ...
            ).apply(instance, OmnidensDungeon::new));
    ...
    public OmnidensDungeon(StructureSettings config,
...
/*
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!OmnidensDungeon.extraSpawningChecks(context)) {
...
/*
    ...
    public StructureType<?> type() {
        return Structureregisteries.OMNIDENSSTRUCTURE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}*/