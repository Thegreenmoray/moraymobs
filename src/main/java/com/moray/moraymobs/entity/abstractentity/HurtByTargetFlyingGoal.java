...
public class HurtByTargetFlyingGoal extends TargetGoal {
    ...
    public HurtByTargetFlyingGoal(FlyingMob mob, Class<?>... toIgnoreDamage) {
        super(mob, true);
    ...
    public HurtByTargetFlyingGoal setAlertOthers(Class<?>... reinforcementTypes) {
    ...
    protected void alertOthers() {
        ...
        AABB aabb = AABB.unitCubeFromLowerCorner(this.mob.position()).inflate(d0, (double)10.0F, d0);
