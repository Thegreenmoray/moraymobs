...
public  class Friendly_Boomerrang extends AbstractHurtingProjectile implements GeoEntity {

    private static final EntityDataAccessor<Integer> BACKWARDS= SynchedEntityData.defineId(Friendly_Boomerrang.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> TIMER= SynchedEntityData.defineId(Friendly_Boomerrang.class, EntityDataSerializers.INT);
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        if (entity instanceof LivingEntity entity1&&getbackwards()<20){
    ...
    public Friendly_Boomerrang(EntityType<? extends AbstractHurtingProjectile> entityType, Level level) {
        super(entityType, level);
    }
    public Friendly_Boomerrang(Level level) {
        super(Mobregistries.BOOMERANG_FRIEND.get(),level);
    }
...
if (gettimer()>=50){
    ...
    private PlayState animations(AnimationState<Friendly_Boomerrang> boomerrangAnimationState) {
